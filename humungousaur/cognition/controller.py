...
class ModelCognitiveDecisionProvider(CognitiveDecisionProvider):
    ...
    def _build_prompt(
        ...
        return (
            ...
            "Use model reasoning over the structured event, current focus, goals, tasks, persona, persona evolutions, self-reviews, interaction reviews, knowledge, learning, consolidations, scheduled wakeups, recoveries, skill evolutions, skills, specialists, and response-mode request.\n"
