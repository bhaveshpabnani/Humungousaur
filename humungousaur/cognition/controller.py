    ...
    def _build_prompt(
        ...
        payload = {
            ...
            "snapshot": {
                ...
                "interaction_reviews": [asdict(record) for record in snapshot.interaction_reviews[:8]],
                "commitments": [asdict(record) for record in snapshot.commitments[:8]],
        ...
        return (
            ...
            "Use model reasoning over the structured event, current focus, goals, tasks, persona, persona evolutions, self-reviews, interaction reviews, commitments, commitment reviews, knowledge, learning, consolidations, scheduled wakeups, recoveries, skill evolutions, skills, specialists, and response-mode request.\n"
