...
class ModelCognitiveDecisionProvider(CognitiveDecisionProvider):
    ...
    def _build_prompt(
        ...
        return (
            ...
            "Use model reasoning over the structured event, current focus, goals, tasks, persona, knowledge, learning, consolidations, scheduled wakeups, recoveries, skills, specialists, and response-mode request.\n"
