...
def request_config(base: AgentConfig, payload: dict[str, Any]) -> AgentConfig:
    ...
    return replace(
        ...
        janus_model_provider=str(payload.get("janus_model_provider", base.janus_model_provider)),
        janus_model_name=str(payload.get("janus_model", base.janus_model_name)),
        janus_model_base_url=payload.get("janus_model_base_url", base.janus_model_base_url),
        janus_model_api_key_env=payload.get("janus_model_api_key_env", base.janus_model_api_key_env),
