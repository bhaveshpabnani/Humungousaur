...
def request_config(base: AgentConfig, payload: dict[str, Any]) -> AgentConfig:
    ...
    return replace(
        ...
        active_model_provider=str(payload.get("active_model_provider", base.active_model_provider)),
        active_model_name=str(payload.get("active_model", base.active_model_name)),
        active_model_base_url=payload.get("active_model_base_url", base.active_model_base_url),
        active_model_api_key_env=payload.get("active_model_api_key_env", base.active_model_api_key_env),
