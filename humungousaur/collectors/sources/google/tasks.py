...
class TasksCollector:
    ...
    def collect(
        ...
        *,
        ...
        return _app_result("tasks", "running", "Google Tasks metadata polled.", cursor=app_state.get("updated_min", ""), events_appended=events_appended, source_channel=self.source_channel, implementation_level=self.implementation_level)
