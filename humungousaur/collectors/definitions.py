...
COLLECTOR_DEFINITIONS: tuple[CollectorDefinition, ...] = (
    ...
    CollectorDefinition(
        ...
        status="implemented_bridge",
        rate_limit_per_minute=20,
        description="Calendar and wakeup bridge events for meetings, deadlines, followups, and scheduled wakeups.",
    ...
    CollectorDefinition(
        ...
        description="Cross-channel bridge events for mentions, DMs, thread replies, reactions, drafts, sends, and unread changes.",
        stimulus_types=(
            "message_received",
            "mention_received",
            "dm_received",
    ...
    CollectorDefinition(
        ...
        status="implemented_bridge",
        rate_limit_per_minute=30,
        description="Mail bridge events for received/opened mail, drafts, attachments, and send failures.",
    ...
    CollectorDefinition(
        ...
        status="implemented_bridge",
        rate_limit_per_minute=30,
        description="Document/spreadsheet/presentation bridge events for opens, edits, comments, suggestions, exports, and formula errors.",
    ...
    CollectorDefinition(
        ...
        status="implemented_bridge",
        rate_limit_per_minute=30,
        description="Creative-tool bridge events for selected frames, exports, asset imports, renders, and timeline changes.",
        stimulus_types=("canvas_selection_changed", "frame_exported", "asset_imported", "render_started", "render_finished", "timeline_marker_changed"),
        bridge_supported=True,
    ),
    CollectorDefinition(
