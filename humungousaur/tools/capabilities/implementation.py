...
CAPABILITY_SURFACES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "groups": ["channels"],
        "expected_tools": ["channel_catalog", "channel_manifest", "channel_setup_status", "channel_message_prepare", "channel_message_send"],
        "purpose": "Receive, prepare, and optionally send messages through configured chat and voice-call channels.",
    },
    {
