...
def check_source_tree(preflight: Preflight) -> None:
    ...
    preflight.require_text(
        ...
        [
            ...
            "HUMUNGOUSAUR_MACOS_CODESIGN_IDENTITY",
            "HUMUNGOUSAUR_MACOS_INSTALLER_IDENTITY",
            "Validate macOS release signing secrets",
            "Public macOS releases must be Developer ID signed, notarized, and stapled",
            "APPLE_APP_SPECIFIC_PASSWORD",
    ...
    preflight.require_text(
        ...
        [
            ...
            "HUMUNGOUSAUR_MACOS_INSTALLER_IDENTITY",
            "HUMUNGOUSAUR_RELEASE_BUILD",
            "Public macOS release builds must be Developer ID signed, notarized, and stapled",
