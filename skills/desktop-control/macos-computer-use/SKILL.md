...
description: Native Humungousaur skill for Macos Computer Use. Use when a task calls for macos computer use workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for macos computer use planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete macos computer use objective, target environment, credentials already configured, and expected artifact or action.
