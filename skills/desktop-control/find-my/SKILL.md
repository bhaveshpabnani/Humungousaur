---
name: find-my
description: Native Humungousaur skill for Find My. Use when a task calls for find my workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for find my planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `find_my_open`
- `find_my_location_request_prepare`
- `computer_use`
- `os_apps`
- `os_launch_app`
- `os_observe_ui`
...
1. Clarify the user's concrete find my objective, target environment, credentials already configured, and expected artifact or action.
