---
name: imessage
description: Native Humungousaur skill for Imessage. Use when a task calls for imessage workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for imessage planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `imessage_draft_create`
- `imessage_send_prepare`
- `imessage_transcript_request_prepare`
- `computer_use`
- `os_apps`
- `os_launch_app`
- `os_observe_ui`
...
1. Clarify the user's concrete imessage objective, target environment, credentials already configured, and expected artifact or action.
