...
6. Save notes or memory only when the user wants durable knowledge.

## Native Implementation Boundaries

- Use Humungousaur web/browser tools.
- Do not import Hermes browser QA, OpenClaw research plugins, or scraper scripts as implementation.
