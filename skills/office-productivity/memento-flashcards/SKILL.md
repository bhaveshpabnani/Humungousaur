...
description: Native Humungousaur skill for Memento Flashcards. Use when a task calls for memento flashcards workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for memento flashcards planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete memento flashcards objective, target environment, credentials already configured, and expected artifact or action.
