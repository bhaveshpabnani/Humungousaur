...
description: Native Humungousaur skill for Finance Modeling. Use when a task calls for finance modeling workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for finance modeling planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete finance modeling objective, target environment, credentials already configured, and expected artifact or action.
