---
name: pinggy-tunnels
description: Native Humungousaur skill for Pinggy Tunnels. Use when a task calls for pinggy tunnels workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for pinggy tunnels planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete pinggy tunnels objective, target environment, credentials already configured, and expected artifact or action.
