...
description: Native Humungousaur skill for Agent Delegation. Use when a task calls for agent delegation workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for agent delegation planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete agent delegation objective, target environment, credentials already configured, and expected artifact or action.
