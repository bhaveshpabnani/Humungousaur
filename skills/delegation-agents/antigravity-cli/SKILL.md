...
description: Native Humungousaur skill for Antigravity Cli. Use when a task calls for antigravity cli workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for antigravity cli planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete antigravity cli objective, target environment, credentials already configured, and expected artifact or action.
