---
name: s6-supervision
description: Native Humungousaur skill for S6 Supervision. Use when a task calls for s6 supervision workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for s6 supervision planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete s6 supervision objective, target environment, credentials already configured, and expected artifact or action.
