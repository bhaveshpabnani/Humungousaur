---
name: openhands
description: Native Humungousaur skill for Openhands. Use when a task calls for openhands workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for openhands planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete openhands objective, target environment, credentials already configured, and expected artifact or action.
