---
name: kanban-worker
description: Native Humungousaur skill for Kanban Worker. Use when a task calls for kanban worker workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for kanban worker planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete kanban worker objective, target environment, credentials already configured, and expected artifact or action.
