...
description: Native Humungousaur skill for Meme Generation. Use when a task calls for meme generation workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for meme generation planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete meme generation objective, target environment, credentials already configured, and expected artifact or action.
