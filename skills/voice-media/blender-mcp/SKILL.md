---
name: blender-mcp
description: Native Humungousaur skill for Blender Mcp. Use when a task calls for blender mcp workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for blender mcp planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete blender mcp objective, target environment, credentials already configured, and expected artifact or action.
