---
name: music-workflows
description: Native Humungousaur skill for Music Workflows. Use when a task calls for music workflows workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for music workflows planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete music workflows objective, target environment, credentials already configured, and expected artifact or action.
