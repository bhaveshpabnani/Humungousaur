---
name: touchdesigner
description: Native Humungousaur skill for Touchdesigner. Use when a task calls for touchdesigner workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for touchdesigner planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete touchdesigner objective, target environment, credentials already configured, and expected artifact or action.
