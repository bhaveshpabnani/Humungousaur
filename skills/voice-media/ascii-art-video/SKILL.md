...
description: Native Humungousaur skill for Ascii Art Video. Use when a task calls for ascii art video workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for ascii art video planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `ascii_video_render_plan_create`
...
1. Clarify the user's concrete ascii art video objective, target environment, credentials already configured, and expected artifact or action.
