---
name: manim
description: Native Humungousaur skill for Manim. Use when a task calls for manim workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for manim planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete manim objective, target environment, credentials already configured, and expected artifact or action.
