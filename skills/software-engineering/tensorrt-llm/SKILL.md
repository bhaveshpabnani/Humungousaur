---
name: tensorrt-llm
description: Native Humungousaur skill for Tensorrt LLM. Use when a task calls for tensorrt llm workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for tensorrt llm planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete tensorrt llm objective, target environment, credentials already configured, and expected artifact or action.
