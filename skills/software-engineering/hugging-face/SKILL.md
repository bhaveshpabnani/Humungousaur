---
name: hugging-face
description: Native Humungousaur skill for Hugging Face. Use when a task calls for hugging face workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for hugging face planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `hugging_face_operation_prepare`
- `execute_code`
- `python_interpreter`
- `process`
- `terminal`
...
1. Clarify the user's concrete hugging face objective, target environment, credentials already configured, and expected artifact or action.
