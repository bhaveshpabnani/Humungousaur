...
description: Native Humungousaur skill for Parallel Research. Use when a task calls for parallel research workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for parallel research planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete parallel research objective, target environment, credentials already configured, and expected artifact or action.
...
4. Collect sources with web/research tools, store evidence, and separate verified facts from hypotheses.
5. For security or OSINT work, use defensive scope, authorization notes, and credential-file policy records before running active checks.
