---
name: pytorch
description: Native Humungousaur skill for Pytorch. Use when a task calls for pytorch workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for pytorch planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `pytorch_training_script_create`
- `execute_code`
- `python_interpreter`
- `process`
- `terminal`
...
1. Clarify the user's concrete pytorch objective, target environment, credentials already configured, and expected artifact or action.
