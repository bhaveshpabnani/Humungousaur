---
name: duckduckgo
description: Native Humungousaur skill for Duckduckgo. Use when a task calls for duckduckgo workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for duckduckgo planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete duckduckgo objective, target environment, credentials already configured, and expected artifact or action.
