---
name: lambda-labs
description: Native Humungousaur skill for Lambda Labs. Use when a task calls for lambda labs workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for lambda labs planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete lambda labs objective, target environment, credentials already configured, and expected artifact or action.
