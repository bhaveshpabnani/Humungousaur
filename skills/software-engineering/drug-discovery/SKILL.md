---
name: drug-discovery
description: Native Humungousaur skill for Drug Discovery. Use when a task calls for drug discovery workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for drug discovery planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete drug discovery objective, target environment, credentials already configured, and expected artifact or action.
