---
name: sherlock
description: Native Humungousaur skill for Sherlock. Use when a task calls for sherlock workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for sherlock planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `sherlock_username_search_prepare`
- `web_search`
- `web_extract`
- `research_web_pages`
- `x_search`
...
1. Clarify the user's concrete sherlock objective, target environment, credentials already configured, and expected artifact or action.
