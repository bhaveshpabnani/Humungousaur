---
name: oss-forensics
description: Native Humungousaur skill for Oss Forensics. Use when a task calls for oss forensics workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for oss forensics planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete oss forensics objective, target environment, credentials already configured, and expected artifact or action.
