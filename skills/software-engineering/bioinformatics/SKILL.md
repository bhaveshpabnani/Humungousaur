---
name: bioinformatics
description: Native Humungousaur skill for Bioinformatics. Use when a task calls for bioinformatics workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for bioinformatics planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `bioinformatics_pipeline_prepare`
- `web_search`
- `web_extract`
- `research_web_pages`
- `x_search`
...
1. Clarify the user's concrete bioinformatics objective, target environment, credentials already configured, and expected artifact or action.
