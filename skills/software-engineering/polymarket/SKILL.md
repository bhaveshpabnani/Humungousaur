---
name: polymarket
description: Native Humungousaur skill for Polymarket. Use when a task calls for polymarket workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for polymarket planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete polymarket objective, target environment, credentials already configured, and expected artifact or action.
