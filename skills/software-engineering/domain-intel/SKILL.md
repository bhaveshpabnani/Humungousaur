---
name: domain-intel
description: Native Humungousaur skill for Domain Intel. Use when a task calls for domain intel workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for domain intel planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete domain intel objective, target environment, credentials already configured, and expected artifact or action.
