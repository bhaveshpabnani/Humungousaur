---
name: onepassword
description: Native Humungousaur skill for Onepassword. Use when a task calls for onepassword workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for onepassword planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
- `tool_output_store`
- `onepassword_item_request_prepare`
- `web_search`
- `web_extract`
- `research_web_pages`
- `x_search`
...
1. Clarify the user's concrete onepassword objective, target environment, credentials already configured, and expected artifact or action.
