---
name: himalaya
description: Native Humungousaur skill for Himalaya. Use when a task calls for himalaya workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for himalaya planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
