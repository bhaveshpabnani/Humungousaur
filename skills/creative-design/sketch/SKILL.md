---
name: sketch
description: Native Humungousaur skill for Sketch. Use when a task calls for sketch workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for sketch planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
...
1. Clarify the user's concrete sketch objective, target environment, credentials already configured, and expected artifact or action.
