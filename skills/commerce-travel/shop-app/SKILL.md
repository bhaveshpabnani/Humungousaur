---
name: shop-app
description: Native Humungousaur skill for Shop App. Use when a task calls for shop app workflows, readiness checks, artifacts, or approval-gated local/provider actions.
---
...
Use this skill when the user asks for shop app planning, execution, verification, troubleshooting, or artifact creation inside Humungousaur.
